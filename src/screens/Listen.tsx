...
export function Listen({ toast }: { toast: (t: string, k?: 'ok' | 'err') => void }) {
  ...
  return (
    <div className="screen listen">
      ...
      <div className="seg seg--view" role="radiogroup" aria-label="Visualizer">
      ...
      {view === 'ring' ? (
        ...
        <>
          ...
          <button type="button" className={`hear-pill${s.monitoring ? ' is-on' : ''}`} onClick={monitor} aria-pressed={s.monitoring}>
